...
<body>
    ...
    <div class="background-img_container">
        ...
        <div class="background-img">
            <svg viewBox="0 0 360 188" fill="none" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M-1 -2H359.327C359.327 -2 405.841 108.249 359.327 162.865C284.814 250.359 -1 74.2097 -1 162.865C-1 251.52 -1 -2 -1 -2Z" fill="#1D6156" />
            </svg>
