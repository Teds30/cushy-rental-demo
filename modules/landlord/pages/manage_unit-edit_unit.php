...
<body>
    <nav class="nav">
        <div class="nav-back">
            <a href="/cr_demo/modules/landlord/pages/manage_units.php">
        ...
        <a href="/cr_demo/modules/landlord/pages/manage_units.php" class=" link-reset">
    ...
    <div class="details-container">
        ...
        <input required="" type="text" placeholder="Unit Name">
