        ...
        <section>
            ...
            <div class="container">
                ...
                <div class="title-container">
                    ...
                    <h1>Manage Inclusions</h1>
                    <a class="btn btn-primary btn-link" href="add_attribute.php?attribute=inclusion">
                                    ...
                                    <div class="td-icon-container">
                                        ...
                                        <div class="td-icon">
                                            <span>
                                                ...
                                                <?php echo file_get_contents(getBaseUrl() . '/assets/icons/electricity.svg') ?>
                                            </span>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td colspan="3" class="td-details">
                                    <div id="data-1" class="attr-details">
                                        <p class="title">Editing Inclusion</p>
                                ...
                                <td>
                                    <div class="td-icon-container">
                                        ...
                                        <div class="td-icon">
                                            <span>
                                                <!-- <i class='bx bx-cctv'></i> -->
                                                <?php echo file_get_contents(getBaseUrl() . '/assets/icons/water.svg') ?>
                                            </span>
                                        </div>
                                    </div>
                                </td>
